...
### <a name="Example_2:_cert_info_functions">Example 2: cert_info functions</a> ###
...
<pre><code>
cert_info() = #cert_info{issuer_cn = binary(), is_production = boolean(), bundle_id = binary(), bundle_seed_id = binary()}
</code></pre>
